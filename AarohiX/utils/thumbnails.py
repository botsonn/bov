...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("AarohiX/assets/Hacen-Sudan.ttf", 30)
    font = ImageFont.truetype("AarohiX/assets/Hacen-Sudan.ttf", 30)
    title_font = ImageFont.truetype("AarohiX/assets/Hacen-Sudan.ttf", 45)
