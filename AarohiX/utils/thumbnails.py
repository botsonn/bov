...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("AarohiX/assets/Blabeloo-font-v.1.0-1.ttf", 30)
    font = ImageFont.truetype("AarohiX/assets/Blabeloo-font-v.1.0-1.ttf", 30)
    title_font = ImageFont.truetype("AarohiX/assets/Blabeloo-font-v.1.0-1.ttf", 45)
