...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("AarohiX/assets/grfico_com_font_tharwat emara ruqaa light.ttf", 30)
    font = ImageFont.truetype("AarohiX/assets/grfico_com_font_tharwat emara ruqaa light.ttf", 30)
    title_font = ImageFont.truetype("AarohiX/assets/grfico_com_font_tharwat emara ruqaa light.ttf", 45)
